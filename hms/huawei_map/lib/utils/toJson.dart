...
Map<String, dynamic> polylineUpdatesToJson(PolylineUpdates polylineUpdates) {
  ...
  addToMap(
      updateMap,
      Param.polylinesToDelete,
      polylineUpdates.deleteSet
          .map<dynamic>((PolylineId m) => m.id)
          .toList());
...
Map<String, dynamic> polygonUpdatesToJson(PolygonUpdates polygonUpdates) {
  ...
  addToMap(
      updateMap,
      Param.polygonsToDelete,
      polygonUpdates.deleteSet
          .map<dynamic>((PolygonId m) => m.id)
          .toList());
...
Map<String, dynamic> markerUpdatesToJson(MarkerUpdates markerUpdates) {
  ...
  addToMap(updateMap, Param.markersToInsert,
      markerToList(markerUpdates.insertSet));
  addToMap(updateMap, Param.markersToUpdate,
      markerToList(markerUpdates.updateSet));
  addToMap(
      updateMap,
      Param.markersToDelete,
      markerUpdates.deleteSet
          .map<dynamic>((MarkerId m) => m.id)
          .toList());
...
Map<String, dynamic> circleUpdatesToJson(CircleUpdates circleUpdates) {
  ...
  addToMap(updateMap, Param.circlesToInsert,
      circleToList(circleUpdates.insertSet));
  addToMap(updateMap, Param.circlesToUpdate,
      circleToList(circleUpdates.updateSet));
  addToMap(
      updateMap,
      Param.circlesToDelete,
      circleUpdates.deleteSet
          .map<dynamic>((CircleId m) => m.id)
          .toList());
